const syntaxes = {
  ...
  '<div class="ml-8 md:my-2"><span class="mr-1 text-emerald-500 text-sm font-medium">#</span> $1</div>': /^- (.*?)$/gm,

  '<div class="ml-14 md:my-2"><span class="mr-1 text-emerald-500 text-sm font-medium">#</span> $1</div>': /^ *?- (.*?)$/gm,
